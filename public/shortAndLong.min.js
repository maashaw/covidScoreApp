...
function kb(){{var a=document.location.protocol+"//"+document.location.hostname+":3000/sendData",b={C:0,B:ha,J:ia,A:fa,v:m.value,F:q.value,H:l.value,I:p.value,D:n.value,G:f};const c=document.createElement("form");c.method="post";c.action=a;for(const e in b)b.hasOwnProperty(e)&&(a=document.createElement("input"),a.type="hidden",a.name=e,a.value=b[e],c.appendChild(a));document.body.appendChild(c);c.submit()}};